...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('culture', ['date'], { name: 'idx_culture_date' });
    await queryInterface.addIndex('culture', ['category'], { name: 'idx_culture_category' });
    ...
    `);
    await queryInterface.sequelize.query(`
      CREATE INDEX idx_culture_search_vector ON culture USING gin (search_vector);
    `);
  },
